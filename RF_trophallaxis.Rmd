...
### Data loading
```{r}
# reading excel file (see attached source file "RF_trophallaxis.csv" and see supplementary Data 1 in a paper "Special food of long-lived kings and queens in termites" for detail)
